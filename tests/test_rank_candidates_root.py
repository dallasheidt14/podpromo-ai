diff --git a/tests/test_rank_candidates.py b/tests/test_rank_candidates_root.py
index 2e4b8eb5aaf6b73aacc05ff3027068e1d5b3d502..397a4f78a87aec0fbbe5767b567b769f22ef681a 100644
--- a/tests/test_rank_candidates.py
+++ b/tests/test_rank_candidates_root.py
@@ -10,61 +10,57 @@ import os
...
+    monkeypatch.setattr("services.secret_sauce.compute_features_v4", fake_compute_features)
